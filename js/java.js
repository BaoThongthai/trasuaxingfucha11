...
submitButton.addEventListener("click", function () {
  ...
  if (inputValue !== "") {
    ...
    if (
      inputValue != "Trà Thanh Đào" &&
      inputValue != "Trà Sữa Khoai Môn" &&
      inputValue != "Oreo Đá Xay" &&
      inputValue != "Socola Đá Xay" &&
      inputValue != "Soda Chanh" &&
      inputValue != "Sữa Dâu" &&
      inputValue != "Sữa Tươi Đường" &&
      inputValue != "TTrà Sữa Truyền Thống"
    ) {
...
window.addEventListener("scroll", () => {
  if (window.scrollY > 100) {
    // Số 100 là khoảng cách từ đỉnh trang web để thêm lớp CSS, là kéo trang xuống dưới 100px là nó show ra)
