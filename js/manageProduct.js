$(document).ready(function () {
  ...
  function searchProductByName(name) {
    $.ajax({
      ...
      success: function (data) {
        ...
        $.each(data, function (index, item) {
          // Kiểm tra nếu tên sản phẩm chứa giá trị tìm kiếm nếu có thì hiển thị ra
  ...
  // Xử lý sự kiện tìm kiếm khi nhập vào Input
  ...
  $(document).ready(function () {
    ...
    $(window).scroll(function () {
      if ($(this).scrollTop() > 50) {
        // bạn có thể điều chỉnh ngưỡng 50 nếu cần
        nav.addClass("navbar");
      } else {
